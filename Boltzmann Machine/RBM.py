# in this file I will impliment 2 restricted boltzman machine models, to give recommandations, based on the
# paper "Introduction to Restricted Boltzmann Machines" by "Asja Fischer".
# using pytorch
